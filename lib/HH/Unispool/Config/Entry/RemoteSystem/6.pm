package HH::Unispool::Config::Entry::RemoteSystem::6;
...
HH::Unispool::Config::Entry::RemoteSystem::6 - UNISPOOL type 6 remote system
...
UNISPOOL type 6 remote system

=head1 DESCRIPTION

Class C<HH::Unispool::Config::Entry::RemoteSystem::6> holds information for UNISPOOL type 6 remote systems
...
Creates a new C<HH::Unispool::Config::Entry::RemoteSystem::6> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. C<OPT_HASH_REF> is mandatory. On error an exception C<Error::Simple> is thrown.
...
sub _initialize {
    ...
    # Check $opt
    ref($opt) eq 'HASH' || throw Error::Simple("ERROR: HH::Unispool::Config::Entry::RemoteSystem::6::_initialize, first argument must be 'HASH' reference.");
    ...
    # os, SINGLE, mandatory
    exists( $opt->{os} ) || throw Error::Simple("ERROR: HH::Unispool::Config::Entry::RemoteSystem::6::_initialize, option 'os' is mandatory.");
    $self->set_os( $opt->{os} );

    # remote_node_name, SINGLE, mandatory
    exists( $opt->{remote_node_name} ) || throw Error::Simple("ERROR: HH::Unispool::Config::Entry::RemoteSystem::6::_initialize, option 'remote_node_name' is mandatory.");
...
sub diff {
    ...
    if ( ref($from) ne ref($to) ) {
        ...
        throw Error::Simple("ERROR: HH::Unispool::Config::Entry::RemoteSystem::6::diff, FROM ($rf) and TO ($rt) reference types differ.");
    }
...
sub get_block_delay {
    ...
    return( $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{block_delay} );
}

sub get_os {
    my $self = shift;

    return( $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{os} );
}

sub get_remote_node_name {
    my $self = shift;

    return( $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{remote_node_name} );
}

sub is_initially_open {
    my $self = shift;

    if ( $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{initially_open} ) {
        return(1);
    }
    else {
        return(0);
...
sub set_block_delay {
    ...
    &_value_is_allowed( 'block_delay', $val ) || throw Error::Simple("ERROR: HH::Unispool::Config::Entry::RemoteSystem::6::set_block_delay, the specified value '$val' is not allowed.");

    # Assignment
    $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{block_delay} = $val;
}
...
sub set_initially_open {
    ...
    if (shift) {
        $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{initially_open} = 1;
    }
    else {
        $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{initially_open} = 0;
    }
}
...
sub set_os {
    ...
    # Check if isa/ref/rx/value is allowed
    &_value_is_allowed( 'os', $val ) || throw Error::Simple("ERROR: HH::Unispool::Config::Entry::RemoteSystem::6::set_os, the specified value '$val' is not allowed.");

    # Assignment
    $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{os} = $val;
}
...
sub set_remote_node_name {
    ...
    # Check if isa/ref/rx/value is allowed
    &_value_is_allowed( 'remote_node_name', $val ) || throw Error::Simple("ERROR: HH::Unispool::Config::Entry::RemoteSystem::6::set_remote_node_name, the specified value '$val' is not allowed.");

    # Assignment
    $self->{HH_Unispool_Config_Entry_RemoteSystem_6}{remote_node_name} = $val;
}
