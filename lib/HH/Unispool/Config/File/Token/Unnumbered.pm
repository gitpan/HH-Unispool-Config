package HH::Unispool::Config::File::Token::Unnumbered;
...
HH::Unispool::Config::File::Token::Unnumbered - abstract class for unnumbered tokens
...
abstract class for unnumbered tokens

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Unnumbered> is an abstract class for unnumbered tokens.
...
Creates a new C<HH::Unispool::Config::File::Token::Unnumbered> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. On error an exception C<Error::Simple> is thrown.
