...
HH::Unispool::Config::File::Token::Numbered::System::Info - system info I<I> token
...
system info I<I> token

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Numbered::System::Info> contans system info I<I> token information.
...
Creates a new C<HH::Unispool::Config::File::Token::Numbered::System::Info> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. On error an exception C<Error::Simple> is thrown.
...
Returns the description for the system,.
...
Set the description for the system,. C<VALUE> is the value. On error an exception C<Error::Simple> is thrown.
...
sub _initialize {
    ...
    # Check $opt
    ref($opt) eq 'HASH' || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Numbered::System::Info::_initialize, first argument must be 'HASH' reference.");
...
sub get_description {
    ...
    return( $self->{HH_Unispool_Config_File_Token_Numbered_System_Info}{description} );
}
...
sub read_string {
    ...
    defined($number) || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Numbered::System::Info::read_string, parameter 'LINE' does not match the regular expression for this token's line string.");
...
sub set_description {
    ...
    &_value_is_allowed( 'description', $val ) || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Numbered::System::Info::set_description, the specified value '$val' is not allowed.");

    # Assignment
    $self->{HH_Unispool_Config_File_Token_Numbered_System_Info}{description} = $val;
}
