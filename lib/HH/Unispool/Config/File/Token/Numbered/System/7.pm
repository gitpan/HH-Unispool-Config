package HH::Unispool::Config::File::Token::Numbered::System::7;
...
HH::Unispool::Config::File::Token::Numbered::System::7 - system type C<7> system I<S> token
...
system type C<7> system I<S> token

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Numbered::System::7> contans system type C<7> system I<S> token information.
...
Creates a new C<HH::Unispool::Config::File::Token::Numbered::System::7> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. C<OPT_HASH_REF> is mandatory. On error an exception C<Error::Simple> is thrown.
...
sub read_string {
    ...
    # Parse line for name
    my ($number, $remote_system_name, $tail) = $line =~ /$USP_S7_RX/;
    defined($number) || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Numbered::System::7::read_string, parameter 'LINE' does not match the regular expression for this token's line string.");
