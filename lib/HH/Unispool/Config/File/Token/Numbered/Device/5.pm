package HH::Unispool::Config::File::Token::Numbered::Device::5;
...
HH::Unispool::Config::File::Token::Numbered::Device::5 - device type C<5> device I<D> token
...
device type C<5> device I<D> token

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Numbered::Device::5> contans device type C<5> device I<D> token information.
...
Creates a new C<HH::Unispool::Config::File::Token::Numbered::Device::5> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. C<OPT_HASH_REF> is mandatory. On error an exception C<Error::Simple> is thrown.
