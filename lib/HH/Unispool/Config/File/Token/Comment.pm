package HH::Unispool::Config::File::Token::Comment;
...
HH::Unispool::Config::File::Token::Comment - Abstract class for comment line string tokens from UNISPOOL config files
...
Abstract class for UNISPOOL comment file tokens

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Comment> is an abstract class for comment line string tokens from UNISPOOL config files.
...
Creates a new C<HH::Unispool::Config::File::Token::Comment> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. On error an exception C<Error::Simple> is thrown.
