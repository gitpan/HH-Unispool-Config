package HH::Unispool::Config::File::Token::Comment::Filter;
...
HH::Unispool::Config::File::Token::Comment::Filter - filter comment token
...
C<HH::Unispool::Config::File::Token::Comment::Filter> contains information on the filter comment token.
...
Creates a new C<HH::Unispool::Config::File::Token::Comment::Filter> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. C<OPT_HASH_REF> is mandatory. On error an exception C<Error::Simple> is thrown.
...
sub read_string {
    ...
    defined($net_desc) || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Comment::Filter::read_string, parameter 'LINE' does not match the regular expression for this token's line string.");
