package HH::Unispool::Config::File::Token::Comment::Group;
...
HH::Unispool::Config::File::Token::Comment::Group - group section comment token
...
group section comment token

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Comment::Group> contains information on the group section comment token.
...
Creates a new C<HH::Unispool::Config::File::Token::Comment::Group> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. C<OPT_HASH_REF> is mandatory. On error an exception C<Error::Simple> is thrown.
...
sub read_string {
    ...
    # Parse line
    my ($net_desc) = $line =~ /$USP_CFG_GRP_RX/;
    defined($net_desc) || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Comment::Group::read_string, parameter 'LINE' does not match the regular expression for this token's line string.");
