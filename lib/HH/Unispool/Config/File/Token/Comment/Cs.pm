package HH::Unispool::Config::File::Token::Comment::Cs;
...
HH::Unispool::Config::File::Token::Comment::Cs - configuration server comment token
...
configuration server comment token

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Comment::Cs> contains information on the configuration server comment token.
...
Creates a new C<HH::Unispool::Config::File::Token::Comment::Cs> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. C<OPT_HASH_REF> is mandatory. On error an exception C<Error::Simple> is thrown.
...
sub read_string {
    ...
    # Parse line
    my ($net_desc) = $line =~ /$USP_CS_INFO_RX/;
    defined($net_desc) || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Comment::Cs::read_string, parameter 'LINE' does not match the regular expression for this token's line string.");
