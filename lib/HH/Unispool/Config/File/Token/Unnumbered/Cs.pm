package HH::Unispool::Config::File::Token::Unnumbered::Cs;
...
HH::Unispool::Config::File::Token::Unnumbered::Cs - class for CS I<C> tokens
...
class for CS I<C> tokens

=head1 DESCRIPTION

C<HH::Unispool::Config::File::Token::Unnumbered::Cs> is a class for CS I<C> tokens.
...
Creates a new C<HH::Unispool::Config::File::Token::Unnumbered::Cs> object. C<OPT_HASH_REF> is a hash reference used to pass initialization options. C<OPT_HASH_REF> is mandatory. On error an exception C<Error::Simple> is thrown.
...
sub read_string {
    ...
    defined($hostname) || throw Error::Simple("ERROR: HH::Unispool::Config::File::Token::Unnumbered::Cs::read_string, parameter 'LINE' does not match the regular expression for this token's line string.");
